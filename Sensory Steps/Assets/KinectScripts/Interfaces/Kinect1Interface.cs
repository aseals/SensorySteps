...
public class Kinect1Interface : DepthSensorInterface 
{
	...
	public bool InitSensorInterface (ref bool bNeedRestart)
	{
		...
		if(!KinectInterop.Is64bitArchitecture())
		{
			...
			dictFilesToUnzip["msvcp100d.dll"] = sTargetPath + "msvcp100d.dll";
			dictFilesToUnzip["msvcr100d.dll"] = sTargetPath + "msvcr100d.dll";
...
//			}
	...
	public bool InitBackgroundRemoval()
	{
	...
	public void FinishBackgroundRemoval()
	{
		FinishBackgroundRemovalNative();
		bBackgroundRemovalInited = false;
	}
	
	public bool UpdateBackgroundRemoval()
	{
	...
	public bool PollForegroundFrame(KinectInterop.SensorData sensorData, bool isHiResPrefered, Color32 defaultColor, ref byte[] fgImageFrame)
	{
		uint frameLen = (uint)fgImageFrame.Length;
		
		var pFrameData = GCHandle.Alloc(fgImageFrame, GCHandleType.Pinned);
